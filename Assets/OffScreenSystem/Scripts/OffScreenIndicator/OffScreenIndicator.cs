...
public class OffScreenIndicator : MonoBehaviour
{
    ...
    void DrawIndicators()
    {
        foreach(Target target in targets)
        {
            ...
            float distanceFromCamera = target.NeedDistanceText ? target.GetDistanceFromCamera(player.transform.position) : float.MinValue;// Gets the target distance from the camera.
